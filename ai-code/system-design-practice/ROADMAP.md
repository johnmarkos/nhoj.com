...
- [ ] **Bulk-add references** — Add `references` to problems where authoritative further reading exists. POC done: 5 problems in Unit 1 Chapter 1 (ref-010, ref-019, ref-022, ref-025, ref-050). Not every problem needs references — focus on problems where a canonical source (RFC, SRE Book, official docs) adds clear value.
...
- [ ] **Further reading links** — Add `references` (array of `{ title, url }`) to problems where authoritative sources exist. Engine/UI support shipped in v2.8.2. POC done: 5 problems in Unit 1 Chapter 1. Not every problem needs references.
